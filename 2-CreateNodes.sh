#For this demo ssh into node01
ssh root@node01

# if you have multiple nodes then executes all these instructions on all nodes
...
#GO BACK TO THE TOP AND DO THE SAME FOR node2.
#Just SSH into node2 and run the commands again.
ssh root@node02
